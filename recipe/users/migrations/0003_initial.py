...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_userprofile', (
            ...
            ('mobile_number', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'mobile_number': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
